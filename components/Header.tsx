...
const Header: React.FC = () => {
  return (
    <div className="flex w-full pt-[16px] pr-[220px] pb-[16px] pl-[220px] gap-[1229px] items-center shrink-0 flex-nowrap bg-[#fff] relative shadow-[0_20px_40px_0_rgba(255,173,0,0.29)] z-[2]">
